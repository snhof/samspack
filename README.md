...
Samspack is my personal R package with functions I frequently use in
data analysis and visualization. It includes custom functions for
analyzing eyetracker data and functions to easily run multiple
regression models.
